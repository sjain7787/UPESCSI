...
<?php
   if(isset($_FILES['jpeg_file'])){
      ...
      if(empty($errors)==true){
       ...
       // Database connection
      $conn = new mysqli("localhost","upescit8_upescsi","UPESCSI@2021s",'upescit8_hackathon7');
      // echo "ansh";
   ...
   if ($teammate == 4) {
      ...
      $sql = mysqli_query($conn, "INSERT INTO register (`t_name`, `t_type`, `teammate`, `m1_name`, `m1_email`,`m1_phno`,`m1_stuupes`,`m1_sap`, `m1_gender`,`m1_csiid`,`m2_name`,`m2_email`,`m2_phno`,`m2_stuupes`,`m2_sap`,`m2_gender`,`m2_csiid`,`m3_name`,`m3_email`,`m3_phno`,`m3_stuupes`,`m3_sap`,`m3_gender`,`m3_csiid`,`payment`,`trans_id`,`jpeg_file`)
   VALUES('" . $t_name . "','" . $t_type . "','" . $teammate . "','" . $m1_name . "','" . $m1_email . "','" . $m1_phno . "','" . $m1_stuupes . "','" . $m1_sap . "','" . $m1_gender . "','" . $m1_csiid . "','" . $m2_name . "','" . $m2_email . "','" . $m2_phno . "','" . $m2_stuupes . "','" . $m2_sap . "','" . $m2_gender . "','" . $m2_csiid . "','" . $m3_name . "','" . $m3_email . "','" . $m3_phno . "','" . $m3_stuupes . "','" . $m3_sap . "','" . $m3_gender . "','" . $m3_csiid . "','" . $payment . "','" . $trans_id . "','uploads/" . $file_name . "' )") or die("Cannot connect1 to database!");
   } elseif ($teammate == 2) {
      $sql = mysqli_query($conn, "INSERT INTO register (`t_name`, `t_type`, `teammate`, `m1_name`, `m1_email`,`m1_phno`,`m1_stuupes`,`m1_sap`, `m1_gender`,`m1_csiid`,`m2_name`,`m2_email`,`m2_phno`,`m2_stuupes`,`m2_sap`,`m2_gender`,`m2_csiid`,`payment`,`trans_id`,`jpeg_file`)
   VALUES('" . $t_name . "','" . $t_type . "','" . $teammate . "','" . $m1_name . "','" . $m1_email . "','" . $m1_phno . "','" . $m1_stuupes . "','" . $m1_sap . "','" . $m1_gender . "','" . $m1_csiid . "','" . $m2_name . "','" . $m2_email . "','" . $m2_phno . "','" . $m2_stuupes . "','" . $m2_sap . "','" . $m2_gender . "','" . $m2_csiid . "','" . $payment . "','" . $trans_id . "','uploads/" . $file_name . "' )") or die("Cannot connect1 to database!");
   }
